...
mongoose
  .connect("mongodb+srv://FeedApp:vivekisgr8@cluster0.4infslc.mongodb.net/", {
...
app.post("/register", async (req, res) => {
  ...
  const sendVerificationEmail = async (email, verificationToken) => {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "vivekparashartkd@gmail.com",
        pass: "gsyc yzhp iidt nupq",
      },
    });
    ...
    const mailOptions = {
      ...
      text: `please click the following link to verify your email http://192.168.29.251:3000/verify/${verificationToken}`,
    };
